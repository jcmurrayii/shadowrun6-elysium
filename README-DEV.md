...
* All test implementations are registered within `game.sr6.tests` and only taken and created from there
...
### Test creation
If you don't know how to create a `SuccessTest` implementation the helper function within `TestCreator` available at `game.sr6.test`
